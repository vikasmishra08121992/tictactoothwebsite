...
export default function ForParentsPage() {
  return (
    <>
      <Section tone="wash" size="loose">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-6 text-lg leading-relaxed text-ink/85 md:text-xl">
            The questions parents ask Tic Tac Tooth most often, answered in plain
            language. If yours is not here, ask us by phone or WhatsApp.
          </p>
        </div>
      </Section>
                    ...
                    <div className="space-y-3 leading-relaxed text-ink/85">
                      ...
                      {t.clinical && (
                        <p className="text-sm text-ink/85">
                          General guidance, not a diagnosis. Bring anything
                          specific to an appointment.
                        </p>
                      )}
                    </div>
                  </AccordionContent>
      ...
      <ClosingCta
        title="Something specific to your child?"
        body="Bring the question to an appointment and we will answer it properly."
